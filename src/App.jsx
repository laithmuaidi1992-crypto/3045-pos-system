...
setAppliedCoupon(cp);
const discVal=cp.coupon_type==="percent"?+cp.discount_value:0;
if(discVal>0)setAD(discVal);
...
}}>{appliedCoupon?"✕":(rtl?"تطبيق":"Apply")}</button>
</div>
{appliedCoupon&&<div style={{background:"#f5f3ff",border:"1px solid #c4b5fd",borderRadius:8,padding:"6px 10px",marginTop:4,fontSize:11,display:"flex",justifyContent:"space-between",alignItems:"center"}}>
<span style={{color:"#7c3aed",fontWeight:600}}>🎟️ {appliedCoupon.code}</span>
<span style={{color:"#059669",fontWeight:700}}>{appliedCoupon.coupon_type==="percent"?appliedCoupon.discount_value+"% OFF":fm(+appliedCoupon.discount_value)+" OFF"}</span>
</div>}
