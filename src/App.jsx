...
{/* Receipt content */}
<div id="receipt-print-area" style={{fontFamily:"'Arial',sans-serif",fontSize:paperSize==="A4"?13:paperSize==="88mm"?12:paperSize==="80mm"||paperSize==="88mm"?11:9,maxWidth:paperSize==="A4"?"100%":paperSize==="88mm"?330:paperSize==="80mm"||paperSize==="88mm"?300:220,margin:"0 auto",background:"#fff",padding:paperSize==="A4"?"30px":"12px",border:"1px dashed #d1d5db",borderRadius:8}}>
...
body{font-family:'Arial',sans-serif;font-size:${paperSize==="A4"?"16pt":paperSize==="88mm"?"11pt":paperSize==="80mm"||paperSize==="88mm"?"10pt":"8pt"};
width:100%;padding:${paperSize==="A4"?"0":"2mm"};direction:${rtl?"rtl":"ltr"};line-height:${paperSize==="A4"?"1.7":"1.35"};color:#000}
.wrap{width:100%}
h1,h2{font-size:${paperSize==="A4"?"28pt":paperSize==="88mm"?"15pt":"14pt"};margin-bottom:${paperSize==="A4"?"8mm":"2mm"}}
img{max-height:${paperSize==="A4"?"140px":paperSize==="88mm"?"75px":"60px"};margin:${paperSize==="A4"?"0 auto 10mm":"0 auto 2mm"};display:block}
table{width:100%;border-collapse:collapse;font-size:${paperSize==="A4"?"15pt":paperSize==="88mm"?"11pt":"10pt"};margin:${paperSize==="A4"?"10mm 0":"2mm 0"}}
th,td{padding:${paperSize==="A4"?"8px 6px":"2px"};text-align:${rtl?"right":"left"}}
th{border-bottom:${paperSize==="A4"?"2px":"1px"} solid #000;font-weight:bold;font-size:${paperSize==="A4"?"16pt":paperSize==="88mm"?"11pt":"10pt"}}
td{border-bottom:${paperSize==="A4"?"1px solid #ddd":"none"}}
.c{text-align:center}.r{text-align:${rtl?"left":"right"}}.b{font-weight:bold}
.line{border-top:${paperSize==="A4"?"2px":"1px"} dashed #000;margin:${paperSize==="A4"?"8mm 0":"4px 0"};padding-top:${paperSize==="A4"?"6mm":"4px"}}
.total-line{border-top:${paperSize==="A4"?"3px":"2px"} solid #000;margin-top:${paperSize==="A4"?"6mm":"4px"};padding-top:${paperSize==="A4"?"5mm":"4px"};font-size:${paperSize==="A4"?"22pt":paperSize==="88mm"?"16pt":"12pt"};font-weight:900}
