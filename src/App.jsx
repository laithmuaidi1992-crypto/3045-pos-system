...
const[eProd,setEP]=useState(null);const[ePr,setEPr]=useState("");const[eSt,setESt]=useState("");const[eExp,setEExp]=useState("");const[eCost,setECost]=useState("");
...
<style>
@page{size:${w} ${h};margin:${paperSize==="A4"?"15mm":"2mm"}}
*{margin:0;padding:0;box-sizing:border-box}
body{font-family:'Courier New',monospace;font-size:${paperSize==="A4"?"14pt":paperSize==="80mm"?"10pt":"8pt"};
width:${paperSize==="A4"?"180mm":w};max-width:${paperSize==="A4"?"180mm":w};margin:0 auto;padding:0;direction:${rtl?"rtl":"ltr"};line-height:${paperSize==="A4"?"1.6":"1.3"}}
h1,h2{font-size:${paperSize==="A4"?"22pt":"14pt"}}
img{max-height:${paperSize==="A4"?"100px":"60px"}}
table{width:100%;border-collapse:collapse;font-size:${paperSize==="A4"?"13pt":"10pt"}}
