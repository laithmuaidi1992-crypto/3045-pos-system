...
<td><span style={{padding:"3px 10px",borderRadius:14,fontSize:11,fontWeight:700,background:prodCountBySup[s.name]>0?"#ecfdf5":"#f3f4f6",color:prodCountBySup[s.name]>0?"#059669":"#9ca3af",fontFamily:"var(--m)"}}>{prodCountBySup[s.name]||0}</span></td>
