...
// Check if was already in cart — use ref to avoid stale state read
const wasInCart=cart.find(i=>i.id===p.id);
if(wasInCart){sT("ℹ "+(rtl?"المنتج مضاف بالفعل — الكمية الآن: ":"Already in cart — qty now: ")+(wasInCart.qty+1),"err")}},[beep,voiceOn,batches,rtl,cart]);
