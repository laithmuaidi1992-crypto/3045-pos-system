...
{/* Avatar */}
<div style={{width:72,height:72,borderRadius:"50%",border:"3px solid rgba(255,255,255,.4)",overflow:"hidden",background:"rgba(255,255,255,.15)",display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0}}>
...
<div style={{background:"#fff",border:"1.5px solid #e5e7eb",borderRadius:20,padding:20,display:"flex",alignItems:"center",justifyContent:"space-between",flexWrap:"wrap",gap:12}}>
<div style={{display:"flex",alignItems:"center",gap:12}}>
<div style={{width:44,height:44,borderRadius:14,background:myAtt&&myAtt.clock_in&&!myAtt.clock_out?"#ecfdf5":myAtt&&myAtt.clock_out?"#eff6ff":"#f9fafb",display:"flex",alignItems:"center",justifyContent:"center",fontSize:22}}>🕐</div>
<div>
<div style={{fontSize:14,fontWeight:700,color:"#374151"}}>{t.attendance}</div>
{myAtt&&myAtt.clock_in&&!myAtt.clock_out?<div style={{fontSize:12,color:"#059669",fontWeight:600}}>✓ {t.clockedIn}: {new Date(myAtt.clock_in).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"})}</div>
:myAtt&&myAtt.clock_out?<div style={{fontSize:12,color:"#6b7280"}}>{new Date(myAtt.clock_in).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"})} → {new Date(myAtt.clock_out).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"})} · <strong style={{color:"#2563eb"}}>{myAtt.hours_worked}h</strong></div>
:<div style={{fontSize:12,color:"#9ca3af"}}>{rtl?"لم يتم تسجيل الحضور بعد":"Not clocked in yet"}</div>}
</div>
</div>
<div>
